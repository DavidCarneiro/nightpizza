		  ...
		  if($_POST[cadastrar]){
			...
			?>
				...
				<div class="title_sec">
					...
					<h2>ative ou desative suas entregas</h2>
				</div>
				<section id="protfolio_sec">
					<div class="col-lg-12">
					  <div class="linkmenu">
						  ...
						  <a href="pagamento.php" id="active"><i class="fa fa-credit-card" aria-hidden="true"></i> Formas de Pagamento</a>  &nbsp;&nbsp;|&nbsp; &nbsp; 
						...
						<div>
							...
							if($entrega['entregas'] == 1) { ?>						
								...
								if($_POST[go]) {
									...
									echo '<script>location.href="entregas.php";</script>';
								}
							} else { ?>
