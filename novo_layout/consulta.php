		...
		<div class="row">
			<form action="" method="post">
				<div class="title_sec">
					...
					<h2>Informe o número do pedido</h2>
				</div>
				<div class="search_widget">
					<input id="sr_bx" type="text" name="pedido" placeholder="Busca...."/>
				</div>
				<br>
				<input type="submit" name="enviar" value="Consultar" class="btn btn-primary" style="width:100%;padding:2%;margin-bottom:1%;">
			</form>	
		</div>
	</div>
</section>
		  ...
		  if($_POST[enviar]){
			  if(!$_POST[pedido]){
				echo "<script>alert('Por favor informe o número do pedido!');</script>";  
				 ...
				 $rows = $sel->num_rows;
				 if($rows == 0){
					echo "<script>alert('Pedido não encontrado! Verifique o número digitado e tente novamnete.');</script>"; 
				 }
				 if($rows != 0){
