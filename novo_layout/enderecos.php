		  ...
		  if($_POST[cadastrar]){
			...
			?>
				...
				<section id="protfolio_sec">
					<div class="col-lg-12">
					  <div class="linkmenu">
						  ...
						  <a href="enderecos.php" id="active"><i class="fa fa-map-marker"></i>Endereços</a>  &nbsp;&nbsp;|&nbsp;&nbsp;  
				...
				<br>
					<div class="col-lg-12" >
						<div id="cnt_form">
							<form id="contact-form" class="contact" method="post" action="enderecos.php">
								<div class="form-group">
									<input type="text" name="cep" id="cep" class="form-control name-field" required="required" placeholder="Cep">
								</div>
								<div class="form-group">
									<input type="text" name="rua" id="rua" class="form-control name-field" required="required" placeholder="Rua">
								</div>
								<div class="form-group">
									<input type="text" name="bairro" id="bairro" class="form-control name-field" required="required" placeholder="Bairro">
								</div>
								<div class="form-group">
									<input type="text" name="taxa" id="taxa" class="form-control name-field" required="required" placeholder="Taxa">
								</div>
								<div class="form-group">
								...
								<div>
								  <h3>Categorias</h3>
								  <hr>
								  <?php $sel = $mysqli->query("select * from dl_enderecos order by bairro asc");
								  while($cat = $sel->fetch_array()){?>
								  <p><span><?=$cat[bairro]?></span> | <span><a href="enderecos.php?botao=del&id=<?=$cat[id_end]?>"><img src="img/x.png" width="15" height="15"></a></span></p>
								  <?php }?>
								</div>
							</form> 
						</div>				
