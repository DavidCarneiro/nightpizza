...
$mysqli -> query ("update dl_produtos set nome='".$_POST[nome]."',descricao='".$_POST[descricao]."', preco_p='".str_replace(",",".", $_POST[preco_p])."', preco_m='".str_replace(",",".", $_POST[preco_m])."', preco_g='".str_replace(",",".", $_POST[preco_g])."',categoria='".$_POST[categoria]."',promocao='".$_POST[promocao]."',opcao1='".$_POST[opcao1]."',opcao2='".$_POST[opcao2]."' where id='".$_GET[id]."'");
