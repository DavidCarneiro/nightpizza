...
function listaItens(objeto){    
   ...
   $.each(objeto, function (i, name) {
		...
		if(name.cat.indexOf('Pizza') != -1){
			...
			'<img src="http://zoesolucoes.tempsite.ws/css/produtos/'+name.img+'" width="100%" height="100%" class="ui-li-thumb"><h2 class="controler">'+name.nome+' '+ promocao +'</h1>'+
